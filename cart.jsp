					...
					<div class="row">
						<form method="post">
							...
							<c:if test="${not empty cdatas}">
								<div class="row" style="text-align: right;">
									<div class="continue__btn">
										<button id="delbtn" type="submit" class="btn btn-danger px-3" formaction="deleteCartlist.do" disabled="disabled">삭제</button>
										<button id="paybtn" type="submit" class="btn btn-success px-3" formaction="payPage.do" disabled="disabled">결제</button>
									</div>
								</div>
							</c:if>
						</form>
